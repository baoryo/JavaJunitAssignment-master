...
public class MatrixHelixMorphTest {
    ...
    @Test
    public void test3x3Irregular() {
        int[][] inMatrix  = {{3,2,1}, {5,6,4},{ 9,7,8}};
        int[][] expOutput = {{3, 2, 1}, {7,8,5},{ 9, 4, 6}};
        assertTrue(testEqual(expOutput, MatrixHelixMorph.helix(inMatrix)));
    }
    @Test
    ...
    @Test
    public void test3x4Irregular() {
        int[][] inMatrix  = {{3,2,1}, {5,6,4},{ 9,7,8},{1,8,5}};
        int[][] expOutput = {{3, 2, 1}, {1,8,5},{ 8, 5, 6},{7,9,4}};
        assertTrue(testEqual(expOutput, MatrixHelixMorph.helix(inMatrix)));
    }
}
